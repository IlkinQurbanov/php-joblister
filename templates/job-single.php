...
<h2 class="pahe-header"><?php echo $job->job_title; ?> (<?php echo $job->location; ?>)</h2>
<small>Posted by <?php echo $job->contact_user; ?>  <?php echo $job->post_date; ?></small><br>
...
<br><br>
<div class="well">
    <a href="edit.php?id=<?php echo $job->id; ?>"class="btb btn-default">Edit</a>
